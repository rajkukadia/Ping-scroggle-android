...
public class ControlFragmentMultiplayerAsync extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =
                inflater.inflate(R.layout.fragment_control_scroggle_multiplayer_async, container, false);
        View main = rootView.findViewById(R.id.button_main_multiplayer_async);
