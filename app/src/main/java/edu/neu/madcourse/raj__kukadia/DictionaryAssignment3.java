...
public class DictionaryAssignment3 extends Activity {
    ...
    public InputStream is4;

    public DataInputStream din4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // FirstTimeCommingFor6to25 =true;
         //       FirstTimeCommingFor5and6 = true;
           //             FirstTimeCommingFor25Above = true;
        createStreams();
        setthreewordfile();
        setfourwordfile();
        setButtonListeners();
            ...
            public void afterTextChanged(Editable s) {
               ...
               letter = enteredString.toCharArray();
                if(enteredStringLength>6&&enteredStringLength<11){
                    ...
                    if (enteredStringLength > 10 & enteredStringLength < 16) {
                        try {
                    ...
                    if(enteredStringLength>20&enteredStringLength<26) {
