...
import edu.neu.madcourse.raj__kukadia.assignment5.InstructionsActivityAssignment5;
import edu.neu.madcourse.raj__kukadia.assignment5.ScroggleAssignment5Fragment;

public class TileMultiplayer {
   ...
   public TileMultiplayer(ScroggleMultiplayerFragment game) {
      this.mGame = game;
   }

   public TileMultiplayer deepCopy() {
      TileMultiplayer tile = new TileMultiplayer(iGame);
      tile.setOwner(getOwner());
      if (getSubTiles() != null) {
         TileMultiplayer newTiles[] = new TileMultiplayer[9];
         TileMultiplayer oldTiles[] = getSubTiles();
   ...
   public TileMultiplayer[] getSubTiles() {
      return mSubTiles;
   }

   public void setSubTiles(TileMultiplayer[] subTiles) {
